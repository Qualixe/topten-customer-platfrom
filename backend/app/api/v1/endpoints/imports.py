...
from app.modules.imports.tasks import process_import_batch
from app.modules.imports.validation import InvalidPeriodError, validate_period
...
async def upload_customer_import(
    ...
    app.modules.imports.tasks.process_import_batch, not in this request.
    """
