...
class Customer(Base):
    ...
    # Set/cleared directly by an admin from the Add/Edit Customer dialogs —
    # unlike form_verified_at above, this one is meant to be toggled both
    # ways (see CustomerCreate.verified / CustomerUpdate.verified /
    # app.controllers.customers). Lets an admin add a customer to the
    # Verified Customers list without them having gone through a campaign
    # or the standalone Forms feature.
