...
/** Email counterpart to QuickSendMessageSection — subject + HTML body
 * instead of an SMS message, no personalization tokens or Form attach
 * (the Mailchimp send path sends the body as-is, no {{token}}
 * substitution and no per-campaign landing page), and the EMAIL branch of
 * MessagePreview for a live preview instead of the SMS phone mockup. */
